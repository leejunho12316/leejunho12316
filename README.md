...
- **AWS Cloud** 인프라 위 **LangGraph** 기반 **ToolCalling & RAG AI Agent** 서비스를 **Kubernetes** 환경에서 **안정적으로 배포**할 수 있습니다.
- **Spring** Backend와 **React** Frontend를 사용해 사용자에게 **가치 있는 정보**를 제공할 수 있습니다.
- **HuggingFace LLM Fine-Tuning** 프로젝트를 진행하며 **로컬 LLM** 사용에 대한 이해를 다졌습니다.
...
<img src="https://img.shields.io/badge/LangGraph-1C3C3C?logo=langgraph&logoColor=white"/>
...
<img src="https://img.shields.io/badge/ChromaDB-FF6154"/>
...
Cloud :
<img src="https://img.shields.io/badge/AWS_Cloud-232F3E?logo=amazonwebservices&logoColor=white"/>
...
<img src="https://img.shields.io/badge/Teams-6264A7?logo=microsoftteams&logoColor=white"/>
...
<img src="https://img.shields.io/badge/Miro-050038?logo=miro&logoColor=FFD02F"/>
...
- 25.11.28/ 데이터 분석 준전문가 (ADsP) (ADsP-047002267)/ **한국데이터산업진흥원**
